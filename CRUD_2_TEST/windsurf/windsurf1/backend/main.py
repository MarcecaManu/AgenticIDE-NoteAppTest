...
def update_note(note_id: int, note_update: NoteUpdate):
    ...
    title = note_update.title if note_update.title is not None else row["title"]
    content = note_update.content if note_update.content is not None else row["content"]
